...
export const ListagemDeProduto: React.FC = () => {
          ...
          <TableBody>
            {rows.map(row => (
              ...
              <TableRow key={row.codigo}>               
                ...
                <TableCell>{row.valor.toLocaleString('pt-BR', options)}</TableCell> 
                <TableCell>
                  <IconButton size="small" onClick={() => handleDelete(row.codigo)}>
                    <Icon>delete</Icon>
                  </IconButton>
                  <IconButton size="small" onClick={() => navigate(`/produtos/detalhe/${row.codigo}`)}>
                    <Icon>edit</Icon>
                  </IconButton>
                </TableCell>
              </TableRow>
